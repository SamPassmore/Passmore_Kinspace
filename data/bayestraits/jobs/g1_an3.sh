...
#PBS -o results/bayestraits/logs/g1_an3-output.txt
#PBS -e results/bayestraits/logs/g1_an3-error.txt
...
Iterations 10000000
Sample 500
LogFile $HOME/results/bayestraits/3/g1_an
run
...
Restrict qig 0
Restrict qjg 0
LogFile $HOME/results/bayestraits/3/g1_an_restricted
run
ANSWERS
