...
#PBS -o results/bayestraits/logs/g0_bt3-output.txt
#PBS -e results/bayestraits/logs/g0_bt3-error.txt
...
Iterations 10000000
Sample 500
LogFile $HOME/results/bayestraits/3/g0_bt
run
...
Restrict qdg 0
Restrict qfg 0
LogFile $HOME/results/bayestraits/3/g0_bt_restricted
run
ANSWERS
