...
#PBS -o results/bayestraits/logs/g0_bt2-output.txt
#PBS -e results/bayestraits/logs/g0_bt2-error.txt
...
Iterations 10000000
Sample 500
LogFile $HOME/results/bayestraits/2/g0_bt
run
...
Restrict qdg 0
Restrict qfg 0
LogFile $HOME/results/bayestraits/2/g0_bt_restricted
run
ANSWERS
