...
#PBS -o results/bayestraits/logs/g2_ie1-output.txt
#PBS -e results/bayestraits/logs/g2_ie1-error.txt
...
Iterations 10000000
Sample 500
LogFile $HOME/results/bayestraits/1/g2_ie
run
...
Restrict qaf 0
Restrict qbf 0
LogFile $HOME/results/bayestraits/1/g2_ie_restricted
run
ANSWERS
